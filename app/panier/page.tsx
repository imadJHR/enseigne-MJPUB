        ...
        <div className="max-w-6xl mx-auto">
          ...
          {items.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h2 className="text-2xl font-bold mb-4 text-black">Votre panier est vide</h2>
              <p className="text-gray-600 mb-8">
                Découvrez nos produits et accessoires pour créer votre enseigne parfaite
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/produits">
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white">Voir nos produits</Button>
                </Link>
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-start mb-2">
                            <div>
                              ...
                              {item.material && <p className="text-sm text-gray-600">Matériau: {item.material}</p>}
                ...
                <Card className="bg-white border border-gray-200 shadow-sm sticky top-24">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900">{getTotalPrice().toFixed(2)}€ HT</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Livraison:</span>
                      <span className={shippingCost === 0 ? "text-yellow-600 font-medium" : "text-gray-900"}>
                        {shippingCost === 0 ? "Gratuite" : `${shippingCost}€`}
                      </span>
                    </div>
                    {shippingCost > 0 && (
                      <p className="text-xs text-gray-500">Livraison gratuite à partir de 200€</p>
                    )}
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      <p className="text-sm text-gray-500 mt-1">TVA: {(totalWithShipping * 0.2).toFixed(2)}€</p>
                      <p className="text-sm font-medium mt-1 text-black">
                        Total TTC: {(totalWithShipping * 1.2).toFixed(2)}€
                      </p>
                    </div>
