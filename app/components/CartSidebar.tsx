      ...
      <div className="fixed right-0 top-0 h-full w-96 bg-white border-l border-gray-200 shadow-lg z-50 flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-gray-900">Panier ({getTotalItems()})</h2>
          </div>
          <Button variant="ghost" size="sm" onClick={() => setIsOpen(false)} className="text-gray-500 hover:text-gray-900">
            <X className="h-5 w-5" />
          </Button>
        </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-right mt-1">
                          <span className="text-blue-600 font-bold">{(item.price * item.quantity).toFixed(2)}MAD</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        {items.length > 0 && (
          <div className="border-t border-gray-200 p-4 space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-blue-600 text-xl font-bold">{getTotalPrice().toFixed(2)}MAD HT</span>
            </div>
            <div className="space-y-2">
              <Link href="/panier" onClick={() => setIsOpen(false)}>
                <Button className="w-full bg-blue-600 hover:bg-blue-700">Voir le panier</Button>
              </Link>
              <Button
                variant="outline"
